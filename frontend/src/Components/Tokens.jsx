...
export default function Tokens(){
    ...
    return (
        <>
        <div className="text-2xl text-center text-white font-semibold">Tokens MarketPlace</div>
                ...
                {contracts.map((contract,index)=>{
                    return (
                        <tr className="border-b border-gray-200 hover:bg-gray-50" key={index}>
                            <td className="py-3 px-6 text-white text-left whitespace-nowrap">{contract.name}</td>
                            <td className="py-3 px-6  text-white text-left whitespace-nowrap">{contract.symbol}</td>
                            <td className="py-3 px-6 text-white text-left whitespace-nowrap">{contract.initialSupply}</td>
                            <td className="py-3 px-6 text-white text-left whitespace-nowrap">{parseFloat(contract.salePrice, 4)}$</td>
                            <td className="py-3 px-6 text-white text-left whitespace-nowrap">{contract.availableTokens}</td>
        ...
        {
            contracts.length === 0 && <div className="text-white">Loading...</div>
        }
        </>

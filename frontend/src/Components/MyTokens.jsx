...
export default function MyTokens(){
    ...
    return(
        <>
        <div className="text-2xl text-center font-semibold text-[#21e786]">My Wallet Balance</div>
        {<div>
            ...
            <thead className="bg-gray-100 text-gray-800 uppercase text-sm leading-normal">
                <tr>
                    <th className="py-3 px-6 text-left text-white">Project / Institution</th>
                    <th className="py-3 px-6 text-left text-white">Symbol</th>
                    <th className="py-3 px-6 text-left text-white">Sale Price (ETH)</th>
                    <th className="py-3 px-6 text-left text-white">My Balance</th>
                    <th className="py-3 px-6 text-center text-white">Action</th>
                </tr>
            </thead>
                ...
                {walletBalance.map((contract,index)=>{
                    return (
                        <tr className="border-b border-gray-200 hover:bg-gray-50" key={index}>
                            <td className="py-3 px-6 text-left text-white whitespace-nowrap">{contract.name}</td>
                            <td className="py-3 px-6 text-left text-white whitespace-nowrap">{contract.symbol}</td>
                            <td className="py-3 px-6 text-left text-white whitespace-nowrap">{parseFloat(contract.salePrice, 4)*84}$</td>
                            <td className="py-3 px-6 text-left text-white whitespace-nowrap">{String(contract.balance)}</td>
